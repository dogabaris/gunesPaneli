...
if(enyuksek < sicC){write("Bugünün sıcaklık verilerine göre elektrik üretim potansiyeli çok yüksek!", "sonuc.txt")}

if(endusuk > sicC){write("Bugünün sıcaklık verilerine göre elektrik üretim potansiyeli çok düşük!", "sonuc.txt")}

if(endusuk < sicC && enyuksek > sicC){ write("Bugünün sıcaklık verilerine göre elektrik üretim potansiyeli normal seviyede!", "sonuc.txt")}
